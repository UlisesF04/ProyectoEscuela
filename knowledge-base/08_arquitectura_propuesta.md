...
│   └── package.json
│
├── agent/                        # Python + APScheduler + Resend
│   ├── main.py                   # Punto de entrada, scheduler
│   ├── tasks/
│   │   ├── db_reader.py          # Consultas a PostgreSQL
│   │   ├── notifier.py           # Envío de notificaciones email (Resend)
...
| `RESEND_API_KEY` | API key de Resend para envío de emails | `re_xxxxxxxxxxxx` | Sí |
...
main.py (scheduler APScheduler)
    ...
    │
    └── notifier.py → Envía email vía Resend SDK
            │
