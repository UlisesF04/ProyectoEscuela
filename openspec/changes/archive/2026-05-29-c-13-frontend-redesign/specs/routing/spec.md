# Spec: frontend-routing

## Overview
Arquitectura de rutas anidadas por rol usando React Router v6 `<Outlet />`. Define la estructura completa de rutas con layouts por rol, NotFoundPage como componente dedicado (404 catch-all), UnauthorizedPage como componente extraído, y redirects para rutas raíz.
