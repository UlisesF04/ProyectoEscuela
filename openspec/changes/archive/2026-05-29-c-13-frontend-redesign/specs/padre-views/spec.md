# Spec: frontend-padre-views

## Overview
Separación del monolito `PadreDashboard.jsx` en 4 páginas independientes por ruta más layout base con sidebar rosa. Incluye notas, asistencias, tareas y subida de certificados con selector de hijos.
