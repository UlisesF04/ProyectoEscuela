# Spec: frontend-responsive

## Overview
Adaptación responsiva de todos los dashboards y componentes para mobile (<768px) y tablet (768-1023px) siguiendo las directrices Stitch: sidebar colapsable, grids adaptativos, tablas responsivas, modales fullscreen y touch targets mínimos.
