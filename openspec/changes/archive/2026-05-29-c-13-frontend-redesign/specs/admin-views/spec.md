# Spec: frontend-admin-views

## Overview
Separación del monolito `AdminDashboard.jsx` en 9 páginas independientes por ruta, con sidebar de navegación admin, estados completos (loading/empty/error) y theme tokens violeta suave.
