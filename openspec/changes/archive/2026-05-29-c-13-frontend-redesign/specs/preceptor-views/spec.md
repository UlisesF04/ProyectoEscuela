# Spec: frontend-preceptor-views

## Overview
Separación del monolito `PreceptorDashboard.jsx` en 3 páginas independientes por ruta más layout base con sidebar teal. Incluye registro de asistencia, historial, y justificación con certificados.
