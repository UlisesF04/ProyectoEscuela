...
## Overview
Componentes reutilizables del sistema con estados completos: loading (skeleton), empty (icono+mensaje), error (alert+retry). Incluye EmptyState, LoadingSkeleton, ErrorBoundary, ErrorAlert, GradeForm, AttendanceSummary, ChildSelector, y refactor de DataTable y DashboardLayout.
