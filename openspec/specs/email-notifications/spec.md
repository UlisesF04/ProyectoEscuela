...
> Envío de notificaciones por email vía Resend API. Agente Python con APScheduler que evalúa condiciones académicas y notifica a padres/tutores. Creado por C-10 notification-agent.
